...
if(realuid($conn, $mu) === false){
  header("location:index.php?error=anerroroccor");
  exit();
...
<html style="font-size: 16px;" lang="en">
  <head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="Follow us, Leave a message">
...
<link rel="stylesheet" href="css/Contact.css" media="screen">
    <script class="u-script" type="text/javascript" src="scrips/jquery.js" defer=""></script>
    <script class="u-script" type="text/javascript" src="scrips/scripts.js" defer=""></script>
  ...
  <body class="u-body"><header class="u-clearfix u-header u-header" id="sec-aba3"><div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="index.php" style="padding: 10px 20px;">Signup</a>
    ...
    <section class="u-align-center u-clearfix u-grey-5 u-section-1" id="sec-1d4d">
    ...
    <section class="u-align-center u-clearfix u-section-2" id="sec-e7c7">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h1 class="u-text u-text-default u-text-1">Leave a message </h1>
        <h6 style="color:lime;">For</h6>
        <h3 style="text-align:center;color:springgreen;"><?php echo $_GET['msgme']; ?></h3>

        <div class="u-form u-form-1">
          <form action="includes/sendmsg.inc.php" method="POST" class="u-clearfix u-form-spacing-15 u-form-vertical u-inner-form" style="padding: 15px;" source="custom" name="form">

            <div class="u-form-group u-form-name u-form-group-1">
              <label for="name-6797" class="u-form-control-hidden u-label">Name</label>
              <input type="text" <?php echo "value='".$mu."'"; ?> id="name-6797" name="receiver" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-input-disabled" required="" readonly style="background:whitesmoke;opacity:0.3;">
            </div>
            <div class="u-form-group u-form-message u-form-group-3">
              <label for="message-6797" class="u-form-control-hidden u-label">Address</label>
              <textarea placeholder="Type your message" rows="4" cols="50" id="message-6797" name="msg" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" required="" style="background:whitesmoke;"></textarea>
            </div>
            <div class="u-align-left u-form-group u-form-submit u-form-group-4">
              <button type="submit" name="send" class="u-form u-btn u-btn-submit u-button-style"> send message</button>

            </div>
            <div class="alert alert-sucess u-text-default" style="width:100%;text-align:center;">
              YOUR IDENTITY Is BEEN HIDDEN
            </div>
